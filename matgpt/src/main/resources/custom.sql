...
VALUES
    ...
    (3, 1, 3, '단출한 메뉴에 집중해서 좋아요. 늘 혼자 가서 수육은 먹어보지 못해 아쉽네요.', 5,'uuiduuiduuiduuid003', 1, 50000, 25000, 2, now(), now()),
...
기분이 좋다 ㅎㅎ', 5,'uuiduuiduuiduuid005', 1, 50000, 25000, 2, now(), now()),
    (6, 1, 6, '처음 왔는데 무조건 특으로 맛납니다^^', 5,'uuiduuiduuiduuid006', 1, 50000, 25000, 2, now(), now()),
    (7, 1, 7, '잡내없고 깔끔해서 먹고나도 개운해요!', 3,'uuiduuiduuiduuid007', 1, 50000, 25000, 2, now(), now()),
...
수육 첫점부터 맛있었어요', 5,'uuiduuiduuiduuid010', 1, 50000, 25000, 2, now(), now()),
    ...
    (14, 1, 14, '사람이 많아 한참 기다렸네요ㅠ', 2,'uuiduuiduuiduuid014', 1, 50000, 25000, 2, now(), now()),
    (15, 1, 15, '음식이 너무 자극적이고 양이 너무 부족해요 배부르게 먹으려면 4만원치는 먹어야 할듯', 1,'uuiduuiduuiduuid015', 1, 50000, 25000, 2, now(), now()),
    (16, 1, 16, '.', 2, 'uuiduuiduuiduuid016', 1, 50000, 25000, 2, now(), now()),
    (17, 3, 17, '너무 멋진 공간이에요! 카페 인테리어도 플랜테리어 대박인데 안쪽에 전시 공간도 있고 커피도 맛있어요! 프레츨 장식도 귀엽고! 담에 가면 프레츨 꼭 먹으려고요. 분위기나 공간에 비해 금액도 합리적이고 조용하고 넓고! 직원분들도 다 넘넘 친절하세요. 북적이지 않고 아늑해서 정말 맘에 드는 카페입니다! 이제 명동 근처 가면 무조건 요기 가려구요!!', 5, 'uuiduuiduuiduuid017', 1, 50000, 25000, 2, now(), now()),
    (18, 3, 18, '너티라떼 고소하고 진해서 맛나요😊 프레첼은 맛이 다양하고 예뻤습니다💕 입구에서부터 너무 예쁘게 잘 꾸며져 있었습니다. 매장에서 꽃향기 나요🙂 포토스팟도 많고, 사진찍는거 좋아하시는 분들이라면 방문하시면 넘 좋을 것 같아요❤️ 직원분들도 친절하세요👍🏻', 5, 'uuiduuiduuiduuid018', 1, 50000, 25000, 2, now(), now()),
    (19, 3, 19, '매장이 독특해요 입구부터 출구까지 보는 재미가 있는 카페예요 규모도 꽤 넓고 천장도 높은편이라 시끄럽지도 않고 대화하기 좋아요 쪽파 프레즐 맛있었고 음료랑 커피맛도 좋았습니다 명동에 카페가 많으면서도 갈만한 카페는 그리 많지않은데 요기 딱 좋네요 단골해야겠어요:)', 4, 'uuiduuiduuiduuid019', 1, 50000, 25000, 2, now(), now()),
    (20, 3, 20, '입구부터 프렛첼이 매달려있어서 프렛첼을 먹지 않을 수 없었는데, 먹지 않았으면 크게 후회할 뻔. 쪽파크림치즈와 아몬드 크림치즈도 맛있었으나, 빵 자체가 맛있었음! 홍대 어반플랜트에 만족했기에 이곳도 인테리어와 분위기 기대하고 들렀는데, 왠걸, 홍대의 습한 분위기와도 또 다르고 디저트에 대만족하고 옴 🤩', 5, 'uuiduuiduuiduuid020', 1, 50000, 25000, 2, now(), now()),
    (21, 3, 21, '이런곳이 있는줄 몰랐네요. 넘 신기해요. 커피는 막 맛있다 맛없다 말하긴 그렇지만… 분위기가 먹고 들어갑니다. 상당히 많은 나무들이 입구부터 반겨주고~ 진자 특별한 프레즐이 있어 디저트 먹기 좋은 곳 같아요. 들어갈 수는 없었지만… 꽃밭도 너무 아름답고 기분 좋아지는 곳 입니다 ^^', 5, 'uuiduuiduuiduuid021', 1, 50000, 25000, 2, now(), now()),
    (22, 3, 22, '✅ 맛있는 디저트가 있는 곳 ✅ 믿고 먹을 수 있는 라떼 ✅ 넓은 카페, 테이블 간 간격 적당👍', 3, 'uuiduuiduuiduuid022', 1, 50000, 25000, 2, now(), now()),
    (23, 3, 23, '인테리어예뻐요 음식은 그럭저럭', 3, 'uuiduuiduuiduuid023', 1, 50000, 25000, 2, now(), now()),
    (24, 3, 24, '이 카페는 정말 아름답고 편안한 분위기를 가지고 있어요. 커피 맛도 훌륭하고, 프레즐이나 다른 디저트도 매우 맛있었어요. 내부 인테리어가 참신하고 고급스러워서, 특별한 날이나 친구들과의 모임에도 좋을 것 같아요.', 5, 'uuiduuiduuiduuid024', 1, 50000, 25000, 2, now(), now()),
    (25, 3, 25, '인테리어도 예쁘고 디저트도 맛있는 카페에요. 직원들도 친절해서 기분 좋게 이용할 수 있었습니다.', 5, 'uuiduuiduuiduuid025', 1, 50000, 25000, 2, now(), now()),
    (26, 3, 26, '입구부터 꽃과 나무로 가득해서 정말 예뻐요! 카페 안쪽에도 식물들이 많아서 분위기가 너무 좋아요. 커피랑 디저트도 맛있어서 다음에 또 방문하고 싶은 곳이에요!', 5, 'uuiduuiduuiduuid026', 1, 50000, 25000, 2, now(), now()),
    (27, 3, 27, '프레첼이 맛있어요! 인테리어도 너무 예쁘고 분위기도 좋아요. 특히 직원분들이 친절해서 다음에 또 방문하고 싶어요.', 5, 'uuiduuiduuiduuid027', 1, 50000, 25000, 2, now(), now()),
    (28, 3, 28, '카페 분위기도 좋고, 직원분들도 친절해서 기분 좋게 이용했습니다. 프레첼이랑 커피도 맛있었어요!', 5, 'uuiduuiduuiduuid028', 1, 50000, 25000, 2, now(), now()),
    (29, 3, 29, '커피가 맛있어요! 카페 분위기도 좋고, 직원분들도 친절하셔서 자주 이용하게 될 것 같아요.', 4, 'uuiduuiduuiduuid029', 1, 50000, 25000, 2, now(), now()),
    (30, 3, 30, '분위기도 좋고, 음료도 맛있어요. 직원분들도 친절해서 기분 좋게 이용했습니다.', 4, 'uuiduuiduuiduuid030', 1, 50000, 25000, 2, now(), now()),
    (31, 3, 31, '카페 분위기가 정말 좋아요! 커피랑 디저트도 맛있고, 직원분들도 친절해서 자주 방문하고 싶은 곳입니다.', 5, 'uuiduuiduuiduuid031', 1, 50000, 25000, 2, now(), now()),
    (32, 3, 32, '카페 인테리어가 예쁘고, 커피랑 디저트도 맛있어요. 직원분들도 친절해서 좋은 경험이었습니다.', 5, 'uuiduuiduuiduuid032', 1, 50000, 25000, 2, now(), now()),
